    ...
    return (
        <div className="fixed bottom-20 lg:bottom-6 right-4 z-40 flex flex-col items-end gap-3">
            ...
            <div className={`flex flex-col items-end gap-3 transition-all duration-300 ${isExpanded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
                ...
                >
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow hover:scale-110 transform duration-200">
                ...
                <a
                    ...
                    className="flex items-center gap-3 group flex-row-reverse"
                >
                    <div className="w-12 h-12 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow hover:scale-110 transform duration-200">
            ...
            <div className="relative">
                ...
                {!isExpanded && showBubble && (
                    <div className="absolute right-16 bottom-1 whitespace-nowrap transition-opacity duration-300">
                ...
                <button
                    ...
                    className={`w-14 h-14 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110 active:scale-95 ${isExpanded
